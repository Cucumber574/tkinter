...
questions = [
    ...
    {
        'текст вопроса': 'Каким оператором можно закончить цикл?',
        'варианты ответов': ['exti', 'return', 'break', 'stop'],
...
class App:
    ...
    def make_widgets(self) -> None:
        ...
        self.button_frame = tkinter.Frame(self.question_frame)
    ...
    def positon_widgets(self) -> None:
        ...
        self.button_answer_1.pack(side='left', padx=15)
        self.button_answer_2.pack(side='left', padx=15)
        self.button_answer_3.pack(side='left', padx=15)
        self.button_answer_4.pack(side='left', padx=15)
